...
execute if score @s twb.raycastDist matches 1.. if block ~ ~ ~ #twb:non_solid unless block ~ ~ ~ #twb:exceptions positioned ^ ^ ^.25 run return run function twb:raycast/targeted/loop
